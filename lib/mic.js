...
exports.calculateMIC = function (packet, NwkSKey) {
    ...
    var B0 = Buffer.concat([new Buffer("4900000000", 'hex'), // as spec
    Dir, // direction ('Dir')
    util.reverse(pktBufs.DevAddr), util.reverse(pktBufs.FCnt), util.bufferFromUInt16LE(0), // upper 2 bytes of FCnt (zeroes)
...
exports.calculateJoinRequestMIC = function (packet, AppKey) {
    var pktBufs = packet.getBuffers();
    var cmac_input = Buffer.concat([pktBufs.MHDR, pktBufs.AppEUI, pktBufs.DevEUI, pktBufs.DevNonce]);
...
exports.calculateJoinAcceptMIC = function (packet, AppKey) {
    var pktBufs = packet;
    //console.log(packet);
    var cmac_input = Buffer.concat([pktBufs.MHDR, pktBufs.AppNonce, pktBufs.NetID, pktBufs.DevAddr, pktBufs.DLSettings, pktBufs.RxDelay]);
...
exports.verifyJoinRequestMIC = function (packet, AppKey) {
    var pktBufs = packet.getBuffers();
    var calculated = exports.calculateJoinRequestMIC(packet, AppKey);
